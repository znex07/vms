                    ...
                    <div class="card-body" id="card_some">
                        <div class="container" id="regis_btns">
                            <div class="row justify-content-center"  id="regis_btn">
                                ...
                                <button type="button" id="btn_regis" onclick="window.location='{{ route('persons.create') }}'" class="btn btn-danger"><i class="fa fa-user"> </i> Register</button>
                            </div>
                            </div>
                            <div class="container" id="regis_btns">
                            <div class="row justify-content-center"id="regis_btn">
                                <button type="button" id="btn_regis" class="btn  btn-success" onclick="window.location='{{ route('persons.index') }}'"><i class="fa fa-list"> </i> View</button>
                            </div>
                        </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="card " id="c_color">
                    ...
                    <div class="card-body" id="card_some">
                        <div class="container" id="regis_btns">
                            <div class="row justify-content-center" id="regis_btn">
                                <a type="button" id="btn_regis" class="btn btn-primary" href="search" ><i class="fa fa-qrcode"></i> For Tracing</a>
                            </div>
                        </div>
                        <div class="container" id="regis_btns">
                            <div class="row justify-content-center"id="regis_btn">
                                <a  class="btn btn-info" id="btn_regis" href="reports"><i class="fa fa-print"> </i> Print Reports</a>
                            </div>
                        </div>
                    </div>
                </div>
